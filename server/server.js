...
if (!FRONTEND_URL || !TIKTOK_CLIENT_KEY || !TIKTOK_CLIENT_SECRET) {
...
app.get("/auth/tiktok", (req, res) => {
  ...
  authorize.searchParams.set("redirect_uri", `${(SERVER_URL || originFrom(req))}/auth/tiktok/callback`);
...
app.get("/auth/tiktok/callback", async (req, res) => {
  ...
  const tokenRes = await fetch("https://open-api.tiktok.com/oauth/token", {
    ...
    body: new URLSearchParams({
      ...
      redirect_uri: `${(SERVER_URL || originFrom(req))}/auth/tiktok/callback`
    })
  });
